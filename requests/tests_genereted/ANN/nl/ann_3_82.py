...
class TestDigitClassification:
    ...
    def test_classification_output_type(self):
        ...
        assert isinstance(predicted_results, np.ndarray), "Output is not a numpy array"
        assert predicted_results.dtype == np.int_, "Output type is not int"
    ...
    def test_classification_output_shape(self):
        ...
        assert len(predicted_results.shape) == 1, "Output shape is not one-dimensional"
