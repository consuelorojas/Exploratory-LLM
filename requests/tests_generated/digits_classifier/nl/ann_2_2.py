...
class TestDigitClassification:
    def test_classification_accuracy(self):
        ...
        assert accuracy >= 95, f"Model's classification accuracy is {accuracy:.2f}%, which is less than the required 95%"
    ...
    def test_classification_output_type(self):
        ...
        assert isinstance(predicted_results, np.ndarray), "Classification output is not a numpy array"
        assert predicted_results.dtype == np.int_, "Classification output type is not int"
    ...
    def test_classification_output_shape(self):
        ...
        assert len(predicted_results.shape) == 1, "Classification output shape is not one-dimensional"
